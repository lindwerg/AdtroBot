...
type: checkpoint
wave: 7
depends_on: ["09-01", "09-02", "09-03", "09-04", "09-05", "09-06", "09-07", "09-08", "09-09", "09-10", "09-11", "09-13", "09-14"]
files_modified:
  - docker-compose.yml
...
<task type="human-verify">
  ...
  <action>
    ...
    **Functional verification:**
    ...
    4. Messages: Verify message history shows correctly (Telegram delivery tested in 09-07)
    5. Export: Download users CSV, verify content
    6. Content: Edit horoscope text, verify it saves
    7. Tarot Spreads: View spread detail with interpretation
  </action>
  <verify>
    Human confirms:
    - [ ] Login works
    ...
    - [ ] Messages history displays correctly
    - [ ] Telegram delivery was verified in 09-07 (skip re-test here)
    - [ ] CSV export downloads correctly
    - [ ] Content page shows horoscope texts
    - [ ] Tarot spreads page shows user questions
...
7. Messaging history displays correctly (Telegram delivery verified in 09-07)
...
- All 13 previous plans integrated correctly
