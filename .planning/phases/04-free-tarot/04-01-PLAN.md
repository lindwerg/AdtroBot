...
3. Скачать датасет карт ekelen/tarot-api:
   - Получить JSON с 78 картами (name, name_short, type, meaning_up, meaning_rev)
   - Сохранить в src/data/tarot/cards.json
   - Формат: {"cards": [...78 cards...]}
...
Источники:
- https://github.com/ekelen/tarot-api (JSON)
- https://luciellaes.itch.io/rider-waite-smith-tarot-cards-cc0 (изображения)

ВАЖНО: Если не получается скачать автоматически, создать cards.json вручную с данными из ekelen/tarot-api и placeholder изображения (можно создать позже).
  </action>
  <verify>
    ...
    - `ls src/data/tarot/images/*.jpg | wc -l` выводит 78 (или placeholder если не скачаны)
  </verify>
  <done>
    Pillow установлен, cards.json содержит 78 карт с meanings, изображения карт в images/
  </done>
</task>
...
- 78 карт в src/data/tarot/cards.json
- 78 изображений в src/data/tarot/images/ (или placeholder)
